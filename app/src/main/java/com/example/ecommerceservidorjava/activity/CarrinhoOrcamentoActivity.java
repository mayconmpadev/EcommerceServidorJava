...
public class CarrinhoOrcamentoActivity extends AppCompatActivity implements CarrinhoOrcamentoAdapter.OnClickLister {
    private ActivityCarrinhoOrcamentoBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCarrinhoOrcamentoBinding.inflate(getLayoutInflater());
        ...
        binding.includeSheet.btnContinue.setOnClickListener(view -> {
            Intent intent = new Intent(getApplicationContext(), CheckoutOrcamentoActivity.class);
    ...
    private void showDialogPreco(ItemVenda itemVenda, int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(
                CarrinhoOrcamentoActivity.this, R.style.CustomAlertDialog2);

        DialogPadraoOkCancelarValorBinding precoBinding = DialogPadraoOkCancelarValorBinding
                .inflate(LayoutInflater.from(CarrinhoOrcamentoActivity.this));
