...
public class ListaUsuarioActivity extends AppCompatActivity implements ListaUsuarioAdapter.OnClickLister, ListaUsuarioAdapter.OnLongClickLister {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityListaUsuarioBinding.inflate(getLayoutInflater());
    ...
    private void recuperaProdutos() {
        ...
        Query produtoRef = FirebaseHelper.getDatabaseReference()
                .child("empresas").child(Base64Custom.codificarBase64(spm.getPreferencia("PREFERENCIAS", "CAMINHO",""))).child("usuarios").orderByChild("nome");
