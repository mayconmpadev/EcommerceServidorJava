...
public class GerarPDFVendas extends AppCompatActivity {
    ...
    public GerarPDFVendas(Venda venda, Context context) {
        this.venda = venda;
    ...
    private void createPdf(Venda venda, PerfilEmpresa perfilEmpresa) throws IOException, DocumentException {
        ...
        Paragraph p19 = new Paragraph(10, venda.getIdUsuario().getNome(), paragraphFont);
