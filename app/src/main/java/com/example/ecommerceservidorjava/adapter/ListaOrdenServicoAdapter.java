...
public class ListaOrdenServicoAdapter extends RecyclerView.Adapter<ListaOrdenServicoAdapter.MyViewHolder> {
    ...
    public ListaOrdenServicoAdapter(int layout, List<Venda> clienteList, Context context, boolean favorito, OnClickLister onClickLister, OnLongClickLister onLongClickLister) {
        this.layout = layout;
